...
//}
//
//final class NetworkManager2: Networkable2 {
...
//    }
////
////    public func checkUserExist(_ urlConfig: URLConfigurator, completion: @escaping (UserExistCheckResponse) -> Void) {
//////        let requestUrl = baseUrl + "/app/users?token=\(uid)"
////        let requestUrl = urlConfig.fullUrl?.absoluteString
////
...
struct UserQuizeAnswer: Encodable
//    Codable
{
    let questionId: Int
    let answer: Int
